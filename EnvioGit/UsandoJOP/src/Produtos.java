...
public class Produtos {
	...
	public static void main(String[] args) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "O valor do desconto é de : R$  " + String.format("%.2f", valor_do_desconto)  + ", portanto o valor final fica em: R$ " + String.format("%.2f", ValorFinal));
			
		}catch(NumberFormatException erro) {
			JOptionPane.showMessageDialog(null, "HOUVE UM ERRO DE CONVERSÃO, DIGITE APENAR NUMEROS");
